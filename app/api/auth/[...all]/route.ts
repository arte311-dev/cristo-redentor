  ...
  if (decision.isDenied()) {
    if (decision.reason.isRateLimit()) {
      ...
      if (decision.reason.emailTypes.includes("INVALID")) {
        message = "El formato de la dirección de correo electrónico no es válido. ¿Hay algún error tipográfico?";
      } else if (decision.reason.emailTypes.includes("DISPOSABLE")) {
        message = "No se permiten direcciones de correo electrónico desechables.";
      } else if (decision.reason.emailTypes.includes("NO_MX_RECORDS")) {
        message =
          "Tu dominio de correo electrónico no tiene un registro MX. ¿Hay algún error tipográfico?";
      } else {
